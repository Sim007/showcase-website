import { DEELSYSTEEM_LABELS, OUTCOME_META } from '../statusMeta.js';
...
export default function ReportTable({ steps }) {
  return (
        ...
        {steps.map((step) => {
          ...
          return (
            <tr key={step.nr}>
              ...
              <td className="deelsysteem">{DEELSYSTEEM_LABELS[step.deelsysteem] || step.deelsysteem}</td>
